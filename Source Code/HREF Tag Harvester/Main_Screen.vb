...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.button_download.Location = New System.Drawing.Point(544, 64)
        Me.button_download.Name = "button_download"
        Me.button_download.Size = New System.Drawing.Size(1, 1)
        Me.button_download.TabIndex = 4
        Me.button_download.Text = "Download"
        Me.ToolTip1.SetToolTip(Me.button_download, "Download the URLS contained in the URL List")
        ...
        Me.txtFiles.Size = New System.Drawing.Size(608, 167)
        ...
        Me.ToolTip1.SetToolTip(Me.Label2, "The results file to which all downloaded URLS are to be saved to")
        '
        'txtSavePath
        '
        ...
        Me.txtSavePath.Text = ""
        Me.ToolTip1.SetToolTip(Me.txtSavePath, "The folder to which all downloaded URLs are to be downloaded to")
        '
        'button_folderbrowse
        '
        Me.button_folderbrowse.BackColor = System.Drawing.Color.Teal
        ...
        Me.button_folderbrowse.ForeColor = System.Drawing.Color.MintCream
        ...
        Me.ToolTip1.SetToolTip(Me.button_folderbrowse, "Select the folder to which all downloaded URLs are to be saved to")
        '
        'Button_ListFiles
        '
        Me.Button_ListFiles.BackColor = System.Drawing.Color.Teal
        Me.Button_ListFiles.Enabled = False
        Me.Button_ListFiles.FlatStyle = System.Windows.Forms.FlatStyle.Flat
        Me.Button_ListFiles.ForeColor = System.Drawing.Color.MintCream
        Me.Button_ListFiles.Location = New System.Drawing.Point(544, 248)
        ...
        Me.Button_ListFiles.Text = "Grab URLS"
        ...
        Me.txtProxy.Location = New System.Drawing.Point(464, 8)
        Me.txtProxy.Name = "txtProxy"
        Me.txtProxy.Size = New System.Drawing.Size(144, 20)
        ...
        'txtselectedfile
        '
        Me.txtselectedfile.BackColor = System.Drawing.Color.LightSeaGreen
        ...
        Me.Button_Pause2.Location = New System.Drawing.Point(464, 64)
        Me.Button_Pause2.Name = "Button_Pause2"
        Me.Button_Pause2.Size = New System.Drawing.Size(1, 1)
        Me.Button_Pause2.TabIndex = 27
        Me.Button_Pause2.Text = "Pause"
        Me.ToolTip1.SetToolTip(Me.Button_Pause2, "Download the URLS contained in the URL List")
        ...
        Me.Button_Pause1.Location = New System.Drawing.Point(544, 248)
        ...
        Me.ToolTip1.SetToolTip(Me.Button_Pause1, "Download the URLs contained in the URL List")
        Me.Button_Pause1.Visible = False
        '
        'fullerrors
        '
        Me.fullerrors.BackColor = System.Drawing.Color.LightSeaGreen
        ...
        Me.fullerrors.ForeColor = System.Drawing.Color.LightSeaGreen
        ...
        'txtParse
        '
        Me.txtParse.ForeColor = System.Drawing.Color.MintCream
        ...
        'txtLastDownload
        '
        Me.txtLastDownload.BackColor = System.Drawing.Color.LightSeaGreen
        Me.txtLastDownload.BorderStyle = System.Windows.Forms.BorderStyle.None
        Me.txtLastDownload.ForeColor = System.Drawing.Color.Honeydew
        ...
        Me.Button_ExitThread.Location = New System.Drawing.Point(504, 248)
        ...
        Me.NotifyIcon1.Text = "HREF Tag Harvester"
        '
        'ContextMenu1
        '
        ...
        Me.MenuItem3.Text = "Show HREF Tag Harvester"
        '
        'MenuItem5
        '
        ...
        'Panel2
        '
        Me.Panel2.Location = New System.Drawing.Point(416, 8)
        ...
        Me.Text = "HREF Tag Harvester (Build 20051219.2)"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal ex As Exception, Optional ByVal identifier_msg As String = "")
        ...
        Catch exc As Exception
            MsgBox("An error occurred in HREF Tag Harvester's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_ListFiles.Click
        ...
        Try
            ...
            Dim finfo As FileInfo = New FileInfo(txtSavePath.Text)
            If finfo.Exists = True Then
                If MsgBox("The results file '" & txtSavePath.Text & "' already exists on the system. Do you wish to overwrite this file?", MsgBoxStyle.YesNo, "Results File Exists") = MsgBoxResult.Yes Then
                    finfo.Delete()
                    continueop = True
                Else
                    continueop = False
    ...
    Public Sub WorkerSnapShotTakenHandler(ByVal Result As String)
        Try
            ...
            If txtFiles.Items.Count > 1 Then
                txtparse_message(txtFiles.Items.Count & " URLS were scraped for download.")
            Else
                txtparse_message(txtFiles.Items.Count & " URL was scraped for download.")
            End If
    ...
    Public Sub WorkerHandler(ByVal Result As String)
        Try
            ...
            If Not Result = "Ignored" Then
                txtLastDownload_Message(("Last URL Handled: " & txtselectedfile.Text.Replace("Downloading: ", "")).Replace("Ignoring: ", ""))
            Else
                txtLastDownload_Message("")
            End If
            txtSelectedFile_Message("")
    ...
    Private Sub button_folderbrowse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles button_folderbrowse.Click
        Try
            ...
            If result = DialogResult.OK Or result = DialogResult.Yes Then
                ...
                '    txtSavePath.Text = txtSavePath.Text & "\"
                'End If
                txtSavePath.Text = (txtSavePath.Text & "\Grabbed_HREFs.txt").Replace("\\", "\")
            End If
        Catch ex As Exception
            If fullerrors.Checked = False Then
                Error_Handler(ex)
    ...
    Public Sub Load_Registry_Values()
        Try
            ...
            For Each str In keys
                If str.Equals("Software\HREF Tag Harvester") = True Then
                    keyflag1 = True
                    Exit For
                End If
            Next str
            ...
            If keyflag1 = False Then
                oReg.CreateSubKey("Software\HREF Tag Harvester")
            End If

            keyflag1 = False

            Dim oKey As RegistryKey = oReg.OpenSubKey("Software\HREF Tag Harvester", True)
            ...
            Else
                configflag = True
                oKey.SetValue("savepath", "C:\Grabbed_HREFs.txt")
                txtSavePath.Text = "C:\Grabbed_HREFs.txt"
            End If
        ...
        Try
            If downloadstatus = True Then
                ...
                If index < download_item_queue.Count Then
                    ...
                    Dim filewriter As StreamWriter = New StreamWriter("c:\testing.txt", True)
                    filewriter.WriteLine(downitem.fileurl)
                    filewriter.Close()
                    ...
                    If downitem.filedownload = True Then
                        ...
                        txtparse_message("Downloading URL " & index + 1 & " of " & txtFiles.Items.Count & ".")
                        txtselectedfile.Refresh()
                    ...
                    Else
                        ...
                        txtparse_message("Ignoring URL " & index + 1 & " of " & txtFiles.Items.Count & ".")
                        txtselectedfile.Refresh()
                        txtStatus_Message(txtselectedfile.Text)
                ...
                Else
                    ...
                    ProgressLabel.Size = inc
                    ProgressLabel.Refresh()
                    byteslabel.Text = "URL List Processed"
                    txtparse_message("Handled URL " & index & " of " & txtFiles.Items.Count & ".")
