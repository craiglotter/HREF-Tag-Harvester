...
#End Region
    ...
    Public Sub WorkerExecute()
        Try
            Dim filewriter As StreamWriter = New StreamWriter(savepath, True)
            filewriter.WriteLine(download.fileurl)
            result = "Captured"
            ...
            RaiseEvent WorkerProgress(200, CLng(download.fileurl.Length), CLng(download.fileurl.Length), "char", CLng(download.fileurl.Length), CLng(download.fileurl.Length))
            filewriter.Close()
        Catch ex As Exception
                        ...
                        Try
                            While stringtoanalyze.IndexOf("href=") > 0
                                If stringtoanalyze.IndexOf("href=""javascript:") < 0 And stringtoanalyze.IndexOf("href=javascript:") < 0 And stringtoanalyze.IndexOf("href='javascript:") < 0 Then
                                    ...
                                    substring = stringtoanalyze.Substring(stringtoanalyze.IndexOf("href=") + 6, (stringtoanalyze.IndexOf(">", stringtoanalyze.IndexOf("href=") + 6)) - (stringtoanalyze.IndexOf("href=") + 6))
                                    'MsgBox(substring)
                                    stringtoanalyze = stringtoanalyze.Remove(0, (stringtoanalyze.IndexOf(">", stringtoanalyze.IndexOf("href=") + 6)) - 1)
